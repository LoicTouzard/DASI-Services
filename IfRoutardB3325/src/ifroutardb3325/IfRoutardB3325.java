...
public class IfRoutardB3325 {
    ...
    public static void main(String[] args) {
       //DEMO 1 : Inscription interactive de clients
            ...
            Client c2 = new Client("M", "Patate", "Robert", "robert.patate@patatat.fr", "laposte", "0322065488");
            
            try {
                Services.creerClient(c1);
                Services.creerClient(c2);
            } catch (Exception ex) {
            ...
            */
            ...
            listePays.add(Services.trouverPays(65L));
            listePays.add(Services.trouverPays(83L));
            List<Voyage> lv=Services.trouverVoyageParPaysEtType(listePays, true, false);
