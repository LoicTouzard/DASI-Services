...
public class DevisDAOJpa implements DevisDAO {
    ...
    @Override
    public void supprimerDevis(Long id) throws NonexistentEntityException{
        EntityManager em = JpaUtil.obtenirEntityManager();
        Devis devis;
            try {
    ...
    @Override
    public Devis modifierDevis(Devis devis) throws NonexistentEntityException{
        try{
            EntityManager em = JpaUtil.obtenirEntityManager();
    ...
    @Override
    public Devis trouverDevis(Long id){
        EntityManager em = JpaUtil.obtenirEntityManager();
