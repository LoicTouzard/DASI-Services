...
public class VoyageDAO {
    ...
    public static List<Voyage> listerVoyageComporantPays(List<Pays> listePays){ //Fonctionne
        return listerVoyageComporantPays(listePays, true, true);
    }
    
    
    public static List<Voyage> listerVoyageComporantPays(List<Pays> listePays, boolean circuit, boolean sejour){ //Fonctionne
        EntityManager em = JpaUtil.obtenirEntityManager();
