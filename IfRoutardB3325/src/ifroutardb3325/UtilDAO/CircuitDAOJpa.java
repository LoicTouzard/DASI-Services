 ...
 * @author ltouzard
 */
public class CircuitDAOJpa implements CircuitDAO {
    ...
    @Override
    public void supprimerCircuit(Long id) throws NonexistentEntityException{
        EntityManager em = JpaUtil.obtenirEntityManager();
        Circuit circuit;
            try {
    ...
    @Override
    public Circuit modifierCircuit(Circuit circuit) throws NonexistentEntityException{
        try{
            EntityManager em = JpaUtil.obtenirEntityManager();
    ...
    @Override
    public Circuit trouverCircuit(Long id){
        EntityManager em = JpaUtil.obtenirEntityManager();
