 ...
 * @author ltouzard
 */
public class DepartDAOJpa implements DepartDAO {
    
    @Override
    public void creerDepart(Depart depart){
        EntityManager em = JpaUtil.obtenirEntityManager();
        em.persist(depart);
    }
    
    @Override
    public void supprimerDepart(Long id) throws NonexistentEntityException{
        EntityManager em = JpaUtil.obtenirEntityManager();
        Depart depart;
            try {
    ...
    @Override
    public Depart modifierDepart(Depart depart) throws NonexistentEntityException{
        try{
            EntityManager em = JpaUtil.obtenirEntityManager();
    ...
    @Override
    public Depart trouverDepart(Long id){
        EntityManager em = JpaUtil.obtenirEntityManager();
        return em.find(Depart.class, id);
    }
    
    @Override
    public List<Depart> listerProchainsDeparts() {
        EntityManager em = JpaUtil.obtenirEntityManager();
        Query query;
